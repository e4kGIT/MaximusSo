                    ...
                    else
                    {
                        if (booStock)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    var empPkQty = dt1.AsEnumerable().Select(s => Convert.ToInt32(s.ItemArray[7].ToString())).ToList();
                                    var rtnQty = line.OrdQty;
                                ...
                                {
                                    var empInvQty = dt1.AsEnumerable().Select(s => Convert.ToInt32(s.ItemArray[6].ToString())).ToList();
                                    var rtnQty = line.OrdQty;
