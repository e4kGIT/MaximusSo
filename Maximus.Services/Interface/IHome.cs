...
namespace Maximus.Services.Interface
{
    public interface IHome
    {
     ...
     List<tblsop_customerorder_template_costcentre> GetCostCenterTemplate(List<string>templateLst, string busId);
        ...
        List<SalesOrderLineViewModel> GetChargableAssembly(string intNoOfday, string IncWendsDel, string CurrencyExchangeRate, string Currency_Name, string Rep_Id, string style = "", long lineNo = 0, long qty = 0, string empId = "", string empName = "", string busId = "", string selTemplates = "", string selUcode = "");
