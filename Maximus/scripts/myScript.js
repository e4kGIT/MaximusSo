...
function GetReOrdProductsPRIVATEORDER(s, e) {
    ...
    if (style != "") {
        ...
        $.ajax({
            ...
            type: "post",
            data: { 'Style': style, 'styleNameArr': styleNameArr, 'colour': styleNameArr[4], 'size': styleNameArr[6], 'qty': styleNameArr[5] },
            success: function (response) {
                if (response != null && response != "") {
                    $.ajax({
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response == "Success") {
                                ...
                                MVCxClientUtils.FinalizeCallback();
                                ReturnReorderGridview.PerformCallback();
        ...
        if (rtnCnfPop != null) {
            if (rtnCnfPop.IsVisible()) {
                ...
                if (document.referrer.indexOf("Home") > -1) {
                    ...
                    if (document.referrer.indexOf("ordeNo") > -1) {
                        window.location = "/Employee/changeordertype?ordertype=manpack";
                    }
                    else {
                        window.location = document.referrer;
                    }
