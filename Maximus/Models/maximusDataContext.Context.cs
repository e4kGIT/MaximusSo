...
namespace Maximus.Models
{
    ...
    public partial class e4kmaximusdbEntities : DbContext
    {
        ...
        public virtual DbSet<tblbus_address_copy> tblbus_address_copy { get; set; }
        ...
        public virtual DbSet<tblbus_settings_copy> tblbus_settings_copy { get; set; }
        ...
        public virtual DbSet<tblonline_emp_address_copy> tblonline_emp_address_copy { get; set; }
        ...
        public virtual DbSet<hr_visexp01_address_map_bak> hr_visexp01_address_map_bak { get; set; }
        ...
        public virtual DbSet<tblbus_address_s27> tblbus_address_s27 { get; set; }
        public virtual DbSet<tblbus_contact_s27> tblbus_contact_s27 { get; set; }
        public virtual DbSet<tblonline_userid_employee_s27> tblonline_userid_employee_s27 { get; set; }
        public virtual DbSet<tblonlinesop_backorders> tblonlinesop_backorders { get; set; }
        public virtual DbSet<tblsop_salesorder_detail_bk> tblsop_salesorder_detail_bk { get; set; }
        public virtual DbSet<tblsop_salesorder_detail_console> tblsop_salesorder_detail_console { get; set; }
        public virtual DbSet<tblsop_salesorder_header_bk> tblsop_salesorder_header_bk { get; set; }
        ...
        public virtual DbSet<hr_tremot02_derbyf> hr_tremot02_derbyf { get; set; }
        public virtual DbSet<hr_tremot02_derbym> hr_tremot02_derbym { get; set; }
        public virtual DbSet<hr_tremot02_langleyf> hr_tremot02_langleyf { get; set; }
        public virtual DbSet<hr_tremot02_langleym> hr_tremot02_langleym { get; set; }
        public virtual DbSet<hr_tremot02_nottmf> hr_tremot02_nottmf { get; set; }
        public virtual DbSet<hr_tremot02_nottmm> hr_tremot02_nottmm { get; set; }
        public virtual DbSet<hr_tremot02_suttonf> hr_tremot02_suttonf { get; set; }
        public virtual DbSet<hr_tremot02_suttonm> hr_tremot02_suttonm { get; set; }
        ...
        public virtual int GetEmployeeDetailnAddProcedure(string busId)
        {
            var busIdParameter = busId != null ?
                new ObjectParameter("busId", busId) :
                new ObjectParameter("busId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetEmployeeDetailnAddProcedure", busIdParameter);
        }
    
        public virtual ObjectResult<GetEmployeeDetailsProcedure_Result> GetEmployeeDetailsProcedure(string busId)
        {
            var busIdParameter = busId != null ?
                new ObjectParameter("busId", busId) :
                new ObjectParameter("busId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEmployeeDetailsProcedure_Result>("GetEmployeeDetailsProcedure", busIdParameter);
        }
    
        public virtual ObjectResult<getSizeColorchangeProcedure_Result> getSizeColorchangeProcedure(string style)
        {
            var styleParameter = style != null ?
                new ObjectParameter("style", style) :
                new ObjectParameter("style", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getSizeColorchangeProcedure_Result>("getSizeColorchangeProcedure", styleParameter);
        }
    
        public virtual ObjectResult<getSizeProcedure_Result> getSizeProcedure(string style)
        {
            var styleParameter = style != null ?
                new ObjectParameter("style", style) :
                new ObjectParameter("style", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getSizeProcedure_Result>("getSizeProcedure", styleParameter);
        }
    
        public virtual ObjectResult<getSize_prod_Result> getSize_prod(string style)
        {
            var styleParameter = style != null ?
                new ObjectParameter("style", style) :
                new ObjectParameter("style", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getSize_prod_Result>("getSize_prod", styleParameter);
        }
